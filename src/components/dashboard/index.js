...
import { Form, Row, Col, Collapse, Table,Modal, Button} from 'react-bootstrap'
import {FaPlus, FaMinus, FaPenAlt, FaJournalWhills} from 'react-icons/fa'
...
const Reports = () => {
    ...
    return (
          <Card>
            <form className="form">
             ...
             <div role="tab"> 
              <h5 className="panel-title">
                  <a id="issuer" aria-expanded={openDashboard} aria-controls="dashboard" onClick={()=>setOpenDashboard(!openDashboard)}> {!openDashboard ? <FaPlus className="icon-style"/> : <FaMinus className="icon-style"/>}&nbsp; Dashboard</a> 
              </h5>
            ...
            <div role="tab"> 
              <h5 className="panel-title">
                  <a id="issuer" aria-expanded={openIssuerDetails} aria-controls="issuer_details" onClick={()=>setOpenIssuerDetails(!openIssuerDetails)}> {!openIssuerDetails ? <FaPlus className="icon-style"/> : <FaMinus className="icon-style"/>}&nbsp; Issuer Details </a> 
              </h5>
            ...
            <div role="tab"> 
              <h5 className="panel-title">
                  <a id="issuer" aria-expanded={openContactDetails} aria-controls="contact_details" onClick={()=>setOpenContactDetails(!openContactDetails)}> {!openContactDetails ? <FaPlus className="icon-style"/> : <FaMinus className="icon-style"/>}&nbsp; Financial Participation </a> 
              </h5>
