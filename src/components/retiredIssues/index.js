                        ...
                        <hr />
                            <tr id={i+1} key={Math.random()}>
                                ...
                                <td style={{verticalAlign: 'bottom', paddingBottom: '10px'}}>
                                    <a className="btn-link add-row"><FiPlusCircle onClick={() => addFinancingContact()}/></a>
                                    <a className="btn-link delete-row"><FiMinusCircle onClick={()=>removeFinancingContact(i)}/></a>
                                </td>
                            </tr>
                            { item.contactRole.code !== "" && <tr>
                                <td>
                                <div>
